...
const title = 'Revolutionizing IPTV Entertainment';
const description =
  'As the lead developer of this IPTV platform, I focused on creating a seamless streaming experience. Our goal was to provide high-quality live TV, movies, and series with a user-friendly interface and global accessibility.';
const roles = [
    ...
    <>
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://github.com/MohamedBoukouch/IPTV_WEB"
          roles={roles}
        />
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
            In 2024, we set out to create a cutting-edge IPTV platform designed to revolutionize
            the way users access entertainment. Traditional cable and streaming services often
            come with limitations such as regional restrictions, high costs, and inconsistent 
            content availability. Our goal was to build a seamless, high-quality streaming 
            experience that provides unlimited access to live TV, movies, and series from 
            around the world. By leveraging the latest technology, we ensure a smooth, 
            reliable service with a user-friendly interface, making premium entertainment more 
          ...
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
             ...
             {/* <ProjectTextRow>
              ...
              and scalable IPTV system. This foundation allows for smooth integration across devices, 
        ...
        <ProjectSection>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
              Providing top-tier IPTV services means staying connected with our users. 
              Our contact section is designed to make reaching out simple and efficient. 
              Whether you have questions, need support, or want to explore our offers, 
        ...
        <ThemeProvider theme="dark" data-invert>
          ...
          >
            ...
            <ProjectTextRow>
            <ProjectSectionHeading>Frequently Asked Questions</ProjectSectionHeading>
              <ProjectSectionText>
                We understand that you may have questions about our IPTV services. 
                Our FAQ section is here to provide quick and clear answers to common inquiries. 
                Whether you're wondering about subscription plans, device compatibility, or troubleshooting issues, 
                you'll find the information you need to enhance your viewing experience.
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
        ...
        <ProjectSection>
          <ProjectSectionColumns>
            ...
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                We offer a variety of IPTV subscription plans to suit your needs, whether you're looking for live TV, 
                on-demand movies, or premium sports channels. Our plans are designed to be affordable, 
                with high-quality streaming and flexible payment options. Choose the perfect plan 
                and enjoy unlimited entertainment on any device.
              </ProjectSectionText>
            </ProjectTextRow>
            </ProjectSectionContent>
